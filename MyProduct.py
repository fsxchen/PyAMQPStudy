...
class MyStomp(stomper.Engine):
    ...
    def connect(self):
        ...
        """
        return stomper.connect(self.username, self.password, "127.0.0.1")
    ...
    def connected(self, msg):
        ...
        f = stomper.Frame()
        f.unpack(stomper.subscribe(DESTINATION, 1))
        return f.pack()
...
def start(host='127.0.0.1', port=61613, username='', password=''):
